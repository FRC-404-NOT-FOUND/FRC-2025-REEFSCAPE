...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kMaxAngularAcceleration = Math.PI; // radians per second persecond
  ...
  public static final class AlgaePivot {
    public static final double DOWN_POSITION = 30.0;  // Set this to the "down" position for the algae pivot
    public static final double UP_POSITION = 0.0; // Adjust this based on your requirements
    public static final int PIVOT_MOTOR_CAN_ID = 12;  // Single motor for algae pivot
  }



  public static final class AlgaeIntakeConstants {
      public static final int LEFT_ALGAE_CAN_ID = 7;
      public static final int RIGHT_ALGAE_CAN_ID = 8;
  }

  public static final class Elevator {
    public static final double SECOND_HEIGHT = 350.0;
